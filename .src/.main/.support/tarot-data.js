...
// ─── DOMAIN OPENING TEMPLATES ─────────────────────────────────────────────────
// 7 domains × 4 models = 28 bilingual opening sentences
const DOMAIN_OPENING_TEMPLATES = {
  career: {
    general:    { vi: "Hành trình sự nghiệp của bạn đang được soi sáng. Ba lá bài này phản chiếu năng lượng quá khứ, hiện tại và tương lai trong con đường nghề nghiệp của bạn.", en: "Your career path is being illuminated. These three cards reflect the past, present, and future energies shaping your professional journey." },
    problem:    { vi: "Bạn đang đối mặt với một rào cản trong sự nghiệp. Các lá bài hé lộ nguyên nhân gốc rễ và năng lượng đang cản bước bạn.", en: "You are facing a block in your career. The cards reveal the root cause and the energy standing in your way." },
    solution:   { vi: "Bạn đang tìm hướng đi trong sự nghiệp. Các lá bài chỉ ra con đường phía trước và hành động cụ thể bạn cần thực hiện.", en: "You are seeking direction in your career. The cards point to the path forward and the concrete action you need to take." },
    crossroads: { vi: "Sự nghiệp của bạn đang đứng trước ngã rẽ quan trọng. Các lá bài soi sáng cả hai hướng đi và hệ quả của từng lựa chọn.", en: "Your career stands at a significant crossroads. The cards illuminate both directions and what each choice carries." }
  },
  love: {
    general:    { vi: "Trái tim bạn đang được lắng nghe. Ba lá bài này phản chiếu hành trình tình cảm và những gì đang định hình mối quan hệ của bạn.", en: "Your heart is being heard. These three cards reflect your emotional journey and what is shaping your relationships." },
    problem:    { vi: "Có điều gì đó trong tình yêu đang tạo ra khoảng cách. Các lá bài tiết lộ nguồn gốc của sự căng thẳng và những gì đang bị che giấu.", en: "Something in love is creating distance. The cards reveal the source of the tension and what is being left unspoken." },
    solution:   { vi: "Bạn đang tìm con đường đến gần hơn trong tình cảm. Các lá bài chỉ ra bước tiếp theo để chữa lành hoặc xây dựng kết nối sâu hơn.", en: "You are seeking a path toward deeper connection. The cards point to the next step for healing or building a stronger bond." },
    crossroads: { vi: "Trái tim bạn đứng trước quyết định lớn. Các lá bài soi sáng hai hướng đi trong tình yêu — và điều mỗi con đường đòi hỏi từ bạn.", en: "Your heart stands before a significant decision. The cards illuminate two directions in love — and what each path asks of you." }
  },
  finance: {
    general:    { vi: "Năng lượng tài chính của bạn đang được phân tích. Ba lá bài này phản chiếu mối quan hệ của bạn với tiền bạc và những gì đang định hình dòng chảy vật chất.", en: "Your financial energy is being examined. These three cards reflect your relationship with money and what is shaping your material flow." },
    problem:    { vi: "Có điều gì đó đang cản trở sự ổn định tài chính của bạn. Các lá bài hé lộ nguồn gốc của vấn đề và những gì cần được giải quyết.", en: "Something is blocking your financial stability. The cards reveal the source of the problem and what needs to be addressed." },
    solution:   { vi: "Bạn đang tìm kiếm con đường đến sự ổn định hoặc thịnh vượng. Các lá bài chỉ ra hành động cụ thể và mindset cần thay đổi.", en: "You are seeking the path to stability or abundance. The cards point to the specific action and the mindset shift required." },
    crossroads: { vi: "Bạn đang đứng trước một quyết định tài chính quan trọng. Các lá bài soi sáng rủi ro và tiềm năng của từng hướng đi.", en: "You stand before an important financial decision. The cards illuminate the risks and potential of each direction." }
  },
  health: {
    general:    { vi: "Năng lượng sức khỏe của bạn đang được soi chiếu. Ba lá bài phản chiếu thể chất, tinh thần và quá trình hồi phục của bạn.", en: "Your health energy is being reflected. These three cards mirror your physical, mental, and healing journey." },
    problem:    { vi: "Có điều gì đó đang ảnh hưởng đến sức khỏe và năng lượng của bạn. Các lá bài hé lộ nguyên nhân và những gì cần được chú ý.", en: "Something is affecting your health and energy. The cards reveal the underlying cause and what needs your attention." },
    solution:   { vi: "Bạn đang tìm con đường đến sự chữa lành hoặc cân bằng. Các lá bài chỉ ra những thay đổi cụ thể cần thực hiện.", en: "You are seeking the path to healing or balance. The cards point to the specific changes you need to make." },
    crossroads: { vi: "Bạn đứng trước một quyết định liên quan đến sức khỏe. Các lá bài soi sáng hệ quả của từng lựa chọn với thể chất và tinh thần của bạn.", en: "You stand before a health-related decision. The cards illuminate the consequences of each choice for your body and mind." }
  },
  family: {
    general:    { vi: "Những mối quan hệ gia đình của bạn đang được soi chiếu. Ba lá bài này phản chiếu năng lượng đang định hình những kết nối quan trọng nhất trong cuộc sống bạn.", en: "Your family connections are being reflected. These three cards mirror the energies shaping the most important relationships in your life." },
    problem:    { vi: "Có sự căng thẳng hoặc rạn nứt trong mối quan hệ gia đình. Các lá bài tiết lộ nguồn gốc của xung đột và những gì đang bị bỏ qua.", en: "There is tension or a rift in your family relationships. The cards reveal the source of the conflict and what is being overlooked." },
    solution:   { vi: "Bạn đang tìm cách hàn gắn hoặc xây dựng lại mối quan hệ gia đình. Các lá bài chỉ ra bước đầu tiên cần thực hiện.", en: "You are seeking to heal or rebuild a family relationship. The cards point to the first step you need to take." },
    crossroads: { vi: "Bạn đứng trước một quyết định ảnh hưởng đến gia đình. Các lá bài soi sáng điều mỗi hướng đi có nghĩa với những người thân yêu của bạn.", en: "You face a decision that affects your family. The cards illuminate what each direction means for those you love." }
  },
  personal: {
    general:    { vi: "Hành trình nội tâm của bạn đang được soi sáng. Ba lá bài này phản chiếu sự phát triển, mục đích và những gì đang định hình con người bạn đang trở thành.", en: "Your inner journey is being illuminated. These three cards reflect your growth, purpose, and what is shaping who you are becoming." },
    problem:    { vi: "Có điều gì đó đang cản trở sự phát triển cá nhân của bạn. Các lá bài hé lộ mô thức đang giữ bạn lại và những gì cần được nhìn nhận.", en: "Something is blocking your personal growth. The cards reveal the pattern holding you back and what needs to be faced." },
    solution:   { vi: "Bạn đang tìm kiếm hướng đi trong sự phát triển cá nhân. Các lá bài chỉ ra bước tiếp theo trên con đường trở thành phiên bản tốt nhất của bạn.", en: "You are seeking direction in your personal growth. The cards point to the next step on the path toward your best self." },
    crossroads: { vi: "Bạn đứng trước một quyết định ảnh hưởng đến bản sắc và định hướng của bạn. Các lá bài soi sáng điều mỗi con đường đòi hỏi bạn từ bỏ và nhận lại.", en: "You stand before a decision that shapes your identity and direction. The cards illuminate what each path asks you to release and receive." }
  },
  general: {
    general:    { vi: "Các lá bài đã lên tiếng. Ba lá này phản chiếu năng lượng quá khứ, hiện tại và tương lai đang định hình hành trình của bạn.", en: "The cards have spoken. These three cards reflect the past, present, and future energies shaping your journey." },
    problem:    { vi: "Bạn đang tìm hiểu điều gì đang cản bước mình. Các lá bài hé lộ nguồn gốc của rào cản và năng lượng đằng sau nó.", en: "You are seeking to understand what is blocking you. The cards reveal the source of the obstacle and the energy behind it." },
    solution:   { vi: "Bạn đang tìm con đường tiếp theo. Các lá bài chỉ ra hành động phù hợp và năng lượng cần được khai thác.", en: "You are seeking the next step. The cards point to the right action and the energy to be channelled." },
    crossroads: { vi: "Bạn đứng trước một lựa chọn quan trọng. Các lá bài soi sáng năng lượng của từng hướng đi và những gì cuộc sống đang mời bạn chọn.", en: "You stand at an important choice. The cards illuminate the energy of each direction and what life is inviting you to choose." }
  }
};

// ─── ARC CLOSING TEMPLATES ────────────────────────────────────────────────────
// Used as fallback for unified narrative P6 when ELEMENT_FLOW_ANALYSIS has no arc
const ARC_CLOSING_TEMPLATES = {
  optimistic:     { vi: "Ba lá bài này cùng nhau tạo nên một hành trình hướng đến ánh sáng — hãy tin vào tiến trình đang diễn ra.", en: "These three cards together form a journey toward light — trust the process that is already unfolding." },
  cautionary:     { vi: "Ba lá bài này phác thảo một con đường đòi hỏi sự tỉnh thức — hãy bước đi chậm rãi và chú ý đến những tín hiệu mà bạn có thể đã bỏ qua.", en: "These three cards outline a path that demands awareness — move deliberately and attend to the signals you may have been dismissing." },
  transformative: { vi: "Sự kết hợp này báo hiệu một sự biến đổi sâu sắc đang diễn ra — những gì đang tan vỡ đang nhường chỗ cho điều thực sự hơn.", en: "This combination signals a profound transformation in motion — what is breaking apart is making room for something more real." },
  contemplative:  { vi: "Ba lá bài này mời bạn hướng vào bên trong trước khi hướng ra bên ngoài — câu trả lời bạn tìm kiếm đang chờ trong sự tĩnh lặng.", en: "These three cards invite you inward before outward — the answer you seek is waiting in stillness." }
};

// ─── INTEGRATED ADVICE TEMPLATES ─────────────────────────────────────────────
// Step 4 of action steps — synthesises all 3 cards in context of domain + model
// Variables: {past}, {present}, {future}, {past_kw}, {present_kw}, {future_kw}
const INTEGRATED_ADVICE_TEMPLATES = {
  career: {
    general:    { vi: "Trong sự nghiệp, bài học từ {past} ({past_kw}) kết hợp với năng lượng hiện tại của {present} gợi ý rằng đây là thời điểm để hành động có chủ đích — chuẩn bị đón nhận những gì {future} ({future_kw}) đang mang lại.", en: "In your career, the lesson of {past} ({past_kw}) combined with the current energy of {present} suggests this is the time to act with intention — preparing to receive what {future} ({future_kw}) is bringing." },
    problem:    { vi: "Rào cản trong sự nghiệp của bạn có nguồn gốc từ {past}. Năng lượng của {present} ({present_kw}) đang kêu gọi bạn đối mặt trực tiếp với nó — và {future} ({future_kw}) cho thấy nếu bạn làm điều đó, con đường phía trước sẽ mở ra.", en: "The block in your career has its roots in {past}. The energy of {present} ({present_kw}) calls you to face it directly — and {future} ({future_kw}) shows that if you do, the path ahead will open." },
    solution:   { vi: "Để tiến về phía trước trong sự nghiệp: hãy kết hợp bài học từ {past} với hành động cụ thể được gợi ý bởi {present} ({present_kw}). Khi bạn làm điều đó, {future} ({future_kw}) là kết quả đang chờ bạn.", en: "To move forward in your career: combine the lesson of {past} with the concrete action suggested by {present} ({present_kw}). When you do, {future} ({future_kw}) is the outcome waiting for you." },
    crossroads: { vi: "Đứng trước ngã rẽ sự nghiệp: {past} đã định hình bạn, {present} ({present_kw}) là nơi bạn đang đứng ngay lúc này. Hãy để {future} ({future_kw}) là la bàn — lựa chọn nào dẫn đến năng lượng đó?", en: "At this career crossroads: {past} has shaped you, {present} ({present_kw}) is where you stand right now. Let {future} ({future_kw}) be the compass — which choice leads toward that energy?" }
  },
  love: {
    general:    { vi: "Trong tình yêu, {past} ({past_kw}) đã tạo nền tảng cảm xúc cho những gì đang xảy ra. {present} ({present_kw}) là thực tế hiện tại — hãy nhìn thẳng vào nó. {future} ({future_kw}) cho thấy những gì có thể nở hoa nếu bạn hành động từ trái tim.", en: "In love, {past} ({past_kw}) laid the emotional foundation for what is happening now. {present} ({present_kw}) is the current reality — look at it clearly. {future} ({future_kw}) shows what can bloom if you act from the heart." },
    problem:    { vi: "Căng thẳng trong tình cảm này có nguồn gốc từ {past}. {present} ({present_kw}) đang kêu gọi một cuộc trò chuyện thật sự — và {future} ({future_kw}) chỉ đến nếu cả hai bên sẵn lòng nhìn thấy sự thật.", en: "The tension in this relationship has its roots in {past}. {present} ({present_kw}) is calling for a genuine conversation — and {future} ({future_kw}) only arrives if both sides are willing to see the truth." },
    solution:   { vi: "Con đường đến gần hơn: hãy bắt đầu bằng cách mang bài học của {past} vào hành động cụ thể mà {present} ({present_kw}) gợi ý. {future} ({future_kw}) là tình cảm đang đợi ở phía bên kia của sự dũng cảm đó.", en: "The path toward deeper connection: start by bringing the lesson of {past} into the concrete action {present} ({present_kw}) suggests. {future} ({future_kw}) is the love waiting on the other side of that courage." },
    crossroads: { vi: "Đứng trước quyết định tình cảm này: {past} cho thấy bạn đã đến đây như thế nào, {present} ({present_kw}) là những gì đang thực sự xảy ra. {future} ({future_kw}) — hãy hỏi bản thân: lựa chọn nào dẫn đến năng lượng này?", en: "At this emotional decision: {past} shows how you got here, {present} ({present_kw}) is what is truly happening. {future} ({future_kw}) — ask yourself: which choice leads toward this energy?" }
  },
  finance: {
    general:    { vi: "Về tài chính, {past} ({past_kw}) đã định hình mối quan hệ của bạn với tiền bạc. {present} ({present_kw}) là thực tế ngay lúc này. Hãy để {future} ({future_kw}) hướng dẫn bước tiếp theo bạn cần thực hiện hôm nay.", en: "Financially, {past} ({past_kw}) has shaped your relationship with money. {present} ({present_kw}) is the reality right now. Let {future} ({future_kw}) guide the next step you need to take today." },
    problem:    { vi: "Vấn đề tài chính này bắt nguồn từ {past}. {present} ({present_kw}) là lúc đối mặt với con số thật sự — và {future} ({future_kw}) cho thấy con đường thoát ra khi bạn hành động cụ thể.", en: "This financial problem originates in {past}. {present} ({present_kw}) is the moment to face the real numbers — and {future} ({future_kw}) shows the way out when you act concretely." },
    solution:   { vi: "Để xây dựng sự ổn định tài chính: kết hợp bài học từ {past} với kỷ luật mà {present} ({present_kw}) đang yêu cầu. {future} ({future_kw}) là kết quả đang đợi khi bạn kiên định.", en: "To build financial stability: combine the lesson of {past} with the discipline {present} ({present_kw}) is requiring. {future} ({future_kw}) is the outcome waiting when you stay the course." },
    crossroads: { vi: "Trước quyết định tài chính này: {past} cho thấy mô thức đã tạo ra tình huống hiện tại, {present} ({present_kw}) là thực tế ngay bây giờ. {future} ({future_kw}) — lựa chọn nào phù hợp hơn với năng lượng đó?", en: "Before this financial decision: {past} shows the pattern that created the current situation, {present} ({present_kw}) is the reality right now. {future} ({future_kw}) — which choice aligns more with that energy?" }
  },
  health: {
    general:    { vi: "Về sức khỏe, {past} ({past_kw}) đã ảnh hưởng đến thể chất và tinh thần bạn theo cách nào đó. {present} ({present_kw}) là những gì cơ thể bạn đang nói lúc này. {future} ({future_kw}) cho thấy hướng đi đến sự cân bằng.", en: "Regarding health, {past} ({past_kw}) has influenced your body and mind in some way. {present} ({present_kw}) is what your body is saying right now. {future} ({future_kw}) shows the direction toward balance." },
    problem:    { vi: "Vấn đề sức khỏe này có liên kết với {past}. {present} ({present_kw}) đang kêu gọi sự chú ý ngay bây giờ — đừng trì hoãn. {future} ({future_kw}) là sức khỏe đang chờ khi bạn lắng nghe cơ thể mình.", en: "This health issue has a connection to {past}. {present} ({present_kw}) is calling for your attention right now — don't delay. {future} ({future_kw}) is the health waiting when you listen to your body." },
    solution:   { vi: "Trên con đường chữa lành: bắt đầu bằng cách tích hợp bài học của {past} vào thói quen hàng ngày mà {present} ({present_kw}) gợi ý. {future} ({future_kw}) là sức sống đang đợi bạn ở phía bên kia.", en: "On the healing path: start by integrating the lesson of {past} into the daily practice {present} ({present_kw}) suggests. {future} ({future_kw}) is the vitality waiting on the other side." },
    crossroads: { vi: "Trước quyết định về sức khỏe này: {past} cho thấy điều gì đang thực sự xảy ra, {present} ({present_kw}) là năng lượng hiện tại của cơ thể bạn. {future} ({future_kw}) — lựa chọn nào tôn trọng cơ thể bạn hơn?", en: "Before this health decision: {past} shows what is really happening, {present} ({present_kw}) is your body's current energy. {future} ({future_kw}) — which choice honors your body more?" }
  },
  family: {
    general:    { vi: "Trong các mối quan hệ gia đình, {past} ({past_kw}) đã định hình năng lượng hiện tại. {present} ({present_kw}) là những gì đang thực sự xảy ra ngay lúc này. {future} ({future_kw}) cho thấy những gì có thể được xây dựng lại hoặc làm sâu sắc thêm.", en: "In your family relationships, {past} ({past_kw}) has shaped the current energy. {present} ({present_kw}) is what is truly happening right now. {future} ({future_kw}) shows what can be rebuilt or deepened." },
    problem:    { vi: "Căng thẳng gia đình này bắt nguồn từ {past}. {present} ({present_kw}) là thời điểm để nhìn nhận sự thật một cách thương yêu — và {future} ({future_kw}) cho thấy sự hàn gắn là có thể khi có sự chân thành.", en: "This family tension originates in {past}. {present} ({present_kw}) is the moment to see the truth with love — and {future} ({future_kw}) shows healing is possible when there is sincerity." },
    solution:   { vi: "Để hàn gắn mối quan hệ gia đình: hãy mang bài học của {past} vào hành động cụ thể mà {present} ({present_kw}) gợi ý — một cuộc trò chuyện, một cử chỉ, một bước nhỏ. {future} ({future_kw}) đang chờ ở phía bên kia.", en: "To heal a family relationship: bring the lesson of {past} into the concrete action {present} ({present_kw}) suggests — a conversation, a gesture, a small step. {future} ({future_kw}) is waiting on the other side." },
    crossroads: { vi: "Trước quyết định ảnh hưởng đến gia đình: {past} cho thấy cách bạn đã đến đây, {present} ({present_kw}) là thực tế mà tất cả mọi người đang sống. {future} ({future_kw}) — lựa chọn nào tốt nhất cho những người bạn yêu thương?", en: "Before the decision affecting your family: {past} shows how you arrived here, {present} ({present_kw}) is the reality everyone is living. {future} ({future_kw}) — which choice serves those you love best?" }
  },
  personal: {
    general:    { vi: "Trong hành trình phát triển cá nhân, {past} ({past_kw}) đã xây dựng nền tảng bạn đang đứng. {present} ({present_kw}) là thách thức và cơ hội hiện tại. {future} ({future_kw}) là người bạn đang trở thành nếu bạn tiếp tục bước đi.", en: "On your personal growth journey, {past} ({past_kw}) built the foundation you stand on. {present} ({present_kw}) is the current challenge and opportunity. {future} ({future_kw}) is who you are becoming if you keep walking." },
    problem:    { vi: "Điều đang cản trở sự phát triển của bạn có nguồn gốc từ {past}. {present} ({present_kw}) là nơi bạn cần nhìn thẳng vào mặt mình — và {future} ({future_kw}) cho thấy ai bạn có thể trở thành khi bạn làm điều đó.", en: "What is blocking your growth has its roots in {past}. {present} ({present_kw}) is where you need to look yourself in the face — and {future} ({future_kw}) shows who you can become when you do." },
    solution:   { vi: "Con đường phía trước: hãy tích hợp bài học của {past} vào thực hành hàng ngày mà {present} ({present_kw}) đang yêu cầu. Từng bước nhỏ dẫn đến {future} ({future_kw}) — đó là định hướng của bạn.", en: "The path forward: integrate the lesson of {past} into the daily practice {present} ({present_kw}) is requiring. Each small step leads toward {future} ({future_kw}) — that is your direction." },
    crossroads: { vi: "Đứng trước quyết định về bản thân: {past} cho thấy ai bạn đã là, {present} ({present_kw}) là ai bạn đang là. {future} ({future_kw}) — lựa chọn nào phù hợp hơn với người bạn đang cố gắng trở thành?", en: "At this personal crossroads: {past} shows who you have been, {present} ({present_kw}) is who you are now. {future} ({future_kw}) — which choice aligns more with who you are trying to become?" }
  },
  general: {
    general:    { vi: "Ba lá bài này cùng nhau: {past} ({past_kw}) đã định hình nơi bạn đang đứng, {present} ({present_kw}) là thực tế ngay lúc này, và {future} ({future_kw}) là năng lượng đang hình thành phía trước. Hành động ngay hôm nay.", en: "These three cards together: {past} ({past_kw}) shaped where you stand, {present} ({present_kw}) is the reality right now, and {future} ({future_kw}) is the energy forming ahead. Act on this today." },
    problem:    { vi: "Rào cản này có liên kết với {past}. {present} ({present_kw}) đang yêu cầu bạn đối mặt với nó — và {future} ({future_kw}) cho thấy điều gì đang chờ đợi khi bạn làm vậy.", en: "This block has a connection to {past}. {present} ({present_kw}) is asking you to face it — and {future} ({future_kw}) shows what is waiting when you do." },
    solution:   { vi: "Con đường tiếp theo: kết hợp bài học của {past} với hành động mà {present} ({present_kw}) đang gợi ý. {future} ({future_kw}) là kết quả đang đợi khi bạn hành động với chủ đích.", en: "The next step: combine the lesson of {past} with the action {present} ({present_kw}) is suggesting. {future} ({future_kw}) is the outcome waiting when you act with intention." },
    crossroads: { vi: "Đứng trước lựa chọn này: {past} cho thấy bạn đã đến đây như thế nào, {present} ({present_kw}) là thực tế hiện tại. Nhìn vào {future} ({future_kw}) — lựa chọn nào phù hợp hơn với năng lượng đó?", en: "At this choice: {past} shows how you got here, {present} ({present_kw}) is the current reality. Look at {future} ({future_kw}) — which option aligns more with that energy?" }
  }
};
